...
// before the game begins
  function preload() {
    game.stage.backgroundColor = '#74bfff';
...
// initial game set up
  function create() {
    ...
    text = game.add.text(16, 10, "Goal: 100 Points ", { font: "bold 30px Super Mario DS (Original)", fill: "pink", });
    text = game.add.text(16,55, "SCORE: " + currentScore, { font: "bold 30px Super Mario DS (Original)", fill: "aqua" });
    winningMessage = game.add.text(game.world.centerX, 275, "", { font: "bold 100px Super Mario DS (Original)", fill: "#EE830A" });
